...
//        new VehicleType(name: '有轨电车',code: 'P',parent: null).save(flush: true)
        ...
        new PlatformManage(ip: '62.123.1.15', port: '2011', name: '合肥客运平台', code: 'K003', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '63.123.1.15', port: '2021', name: '合肥客运平台', code: 'K004', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '64.123.1.15', port: '2031', name: '合肥客运平台', code: 'K005', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '65.123.1.15', port: '2041', name: '合肥客运平台', code: 'K006', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '66.123.1.15', port: '2051', name: '合肥客运平台', code: 'K007', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '67.123.1.15', port: '2061', name: '合肥客运平台', code: 'K008', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '68.123.1.15', port: '2071', name: '合肥客运平台', code: 'K009', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '69.123.1.15', port: '2081', name: '合肥客运平台', code: 'K022', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '611.123.1.15', port: '2091', name: '合肥客运平台', code: 'K202', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '612.123.1.15', port: '2101', name: '合肥客运平台', code: 'K302', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '613.123.1.15', port: '2201', name: '合肥客运平台', code: 'K402', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
        new PlatformManage(ip: '614.123.1.15', port: '2301', name: '合肥客运平台', code: 'K502', contactName: '王平', contactPhone: '13023429743', draftPeople: '吴珊', status: '起草').save(flush: true)
